...
public class ElectrovalvulaBomba {
        ...
        while (true) {
            try {
                if (socket == null || socket.isClosed() || !socket.isConnected()) {
                    ...
                    out.flush();
                    System.out.println("[EV-BOMBA] Handshake enviado: electrovalvula;" + id);
                }
                ...
                System.err.println("[EV-BOMBA] Error de comunicación: " + e.getMessage());
                ...
                System.err.println("[EV-BOMBA] Error al conectar con el líder: " + e.getMessage());
                cerrarRecursos(out, in, socket);
                out = null;
                in = null;
                socket = null;
    ...
    private static Socket abrirConexionConLider() throws Exception {
        ...
        System.out.println("[EV-BOMBA] Conectada a " + info.host() + ":" + info.puerto());
        return socket;
    }
    ...
    private static LiderInfo obtenerInfoLider() {
        ...
        try {
            ...
            System.out.println("[EV-BOMBA] Líder actual: " + host + ":" + puerto);
        } catch (Exception e) {
            System.err.println("[EV-BOMBA] No se pudo obtener líder actual (" + e.getMessage()
                    + "), usando " + host + ":" + puerto + ".");
        }
